    ...
    <div className="footerWrap">
        ...
        <div className="lg:grid lg:grid-cols-2">
            ...
            <div className="grid grid-cols-2 lg:grid lg:grid-cols-2">
                <div className="">
                    <p className="text-white text-1xl underline lg:text-center">About us</p>
                    <p className="text-white text-1xl underline lg:text-center">Follow us</p>
                ...
                <div className="">
                <p className="text-white text-1xl underline lg:text-center">Contact us</p>
                <p className="text-white text-1xl  flex lg:justify-center"><img src={phone} alt="img" className="w-9 pr-4"></img>+91 923456123</p>
                <p className=" hidden lg:text-white lg:text-1xl lg:flex  lg:pl-10 "><img src={mail} alt="img" className="w-12 pr-3"></img>sparky.support@gmail.com</p>
                </div>
            </div>
        </div>
        ...
        <div className="text-center lg:pt-20">
            <p className="text-white text-xl">2023 © Sparky.Ltd | All Right Reserved</p>
        </div>
