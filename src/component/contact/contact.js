          ...
          <div className="info">
            <div className="md:flex justify-between p-7">
              <div className="phone grid">
                ...
                <p className="text-white text-xl m-auto">+91 23456234567</p>
              </div>
              <img
                src={verticalLine}
                alt="img"
              ...
              <div className="phone grid">
                ...
                <p className="text-white text-xl m-auto">sparky@support.com</p>
              </div>
            </div>
          </div>
          <div className="Contactform">
            <p className="text-white text-2xl pt-4 text-center mb-1">
              Leave us a Message
            </p>
            ...
            <div className="content-btn text-center pt-2">
              <button className="text-white font-bold text-center py-2 px-12 align-middle inline-flex  btnlogin contactbtn">
                Submit
              </button>
            </div>
          </div>
